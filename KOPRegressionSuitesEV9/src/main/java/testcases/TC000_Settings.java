...
public class TC000_Settings extends KMABase{
	...
	public void settingsCPEnableToggle(String emailId, String pwdLogin, String invalidPwd, String diffPwd, String state) throws InterruptedException{
	new P2_Login(driver, test)
	...
	public void settingsCPTurnOffToggle(String emailId, String pwdLogin, String invalidPwd, String diffPwd, String state) throws InterruptedException{
	new P2_Login(driver, test)
	...
	public void settingsKiaConnectNotificationAlertsTurnOff(String emailId, String pwdLogin, String invalidPwd, String diffPwd, String state) throws InterruptedException{
	new P2_Login(driver, test)
